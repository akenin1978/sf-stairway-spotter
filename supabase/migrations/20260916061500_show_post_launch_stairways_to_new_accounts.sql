-- New accounts should still hear about stairways added after the durable
-- notification system launched. The original migration timestamp is the
-- boundary between the legacy collection and genuine later additions.
